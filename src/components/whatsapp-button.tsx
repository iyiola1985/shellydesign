    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-50 flex items-center gap-3 sm:bottom-6 sm:right-6"
        >
          <AnimatePresence>
            {tip && (
              <motion.span
